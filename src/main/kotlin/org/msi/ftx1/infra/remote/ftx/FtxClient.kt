...
class FtxClient(
    ...
    fun getTrades(symbol: String, startTimeSeconds: Long, endTimeSeconds: Long): List<FtxTrade> {
        val trades = mutableListOf<FtxTrade>()
    ...
    private fun checkTrades(trades: List<FtxTrade>) {
...
// TODO: le ticker temps reel bouge trop vite, pas ideal de relancer la strat a chaque tick
// il faut mieux se baser sur les trades, ou bien le barchart a la seconde

// TODO: exploiter l'orderbook pour calculer la liquidité des 0.1% up et down, voir si corrélation avec le mouvement de prix immediat
